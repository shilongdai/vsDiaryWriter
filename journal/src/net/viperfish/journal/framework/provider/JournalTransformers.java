...
public enum JournalTransformers {
	INSTANCE;
	private Map<String, TransformerProvider> secureProviders;
	...
	public void registerTransformerProvider(TransformerProvider p) {
	...
	public JournalTransformer newTransformer(String instance) {
		...
		for (Entry<String, TransformerProvider> iter : secureProviders.entrySet()) {
	...
	public Map<String, TransformerProvider> getSecureProviders() {
